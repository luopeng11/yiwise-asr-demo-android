...
public class AsrReqPayloadSerializer extends JsonDeserializer<Map<String, Object>> {

    private static ILogger logger = LoggerFactory.getLogger(AsrReqPayloadSerializer.class);
    ...
    public Map<String, Object> deserialize(JsonParser jp, DeserializationContext ctx) throws IOException, JsonProcessingException {
        ...
        while (fields.hasNext()) {
            ...
            switch (key) {
                case Constant.PROP_ASR_PARAM:
                    RealTimeAsrParam asrResult = JsonUtils.jsonNode2Object(value, RealTimeAsrParam.class);
                    result.put(Constant.PROP_ASR_PARAM, asrResult);
                    break;
                default:
